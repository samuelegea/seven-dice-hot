  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Trait" do
        expect {
          post traits_url, params: { trait: valid_attributes }
        }.to change(Trait, :count).by(1)
      end

      it "redirects to the created trait" do
        post traits_url, params: { trait: valid_attributes }
        expect(response).to redirect_to(trait_url(Trait.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Trait" do
        expect {
          post traits_url, params: { trait: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested trait" do
        trait = Trait.create! valid_attributes
        patch trait_url(trait), params: { trait: new_attributes }
        trait.reload
      ...
      it "redirects to the trait" do
        ...
        patch trait_url(trait), params: { trait: new_attributes }
        trait.reload
        expect(response).to redirect_to(trait_url(trait))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        trait = Trait.create! valid_attributes
        patch trait_url(trait), params: { trait: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
